...
LJ::Hooks::register_hook( 'check_money_order_pending', sub {
    my ( $cart, $u ) = @_;
    ...
    LJ::send_mail( {
        ...
        subject => LJ::Lang::ml( 'shop.admin.checkmoneyorder.subject', { sitename => $LJ::SITENAME } ),
        body => LJ::Lang::ml( 'shop.admin.checkmoneyorder.body', {
